"""
Django settings for radiohead project.
...
ALLOWED_HOSTS = ['radiohead-ms4.herokuapp.com', 'localhost']
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = 'The Home of Radiohead'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'radiohead-ms4'
...
STRIPE_PORTAL_WEBHOOK_SECRET = os.environ.get(
    'STRIPE_PORTAL_WEBHOOK_SECRET', "")
STRIPE_CHECKOUT_WEBHOOK_SECRET = os.environ.get(
