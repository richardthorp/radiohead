...
import base64
import tempfile
from ..forms import AddAlbumForm, AddProductForm


# Test imageField code copied from https://gist.github.com/drillbits/5432699 -
# Written by Vaibhav Vishal
class TestShopForms(TestCase):
    ...
    def test_valid_album_form_is_valid(self):
        form = AddAlbumForm({
            "title": 'Test Album',
            "year": 2020,
            "tracklist": {
    ...
    def test_valid_product_form_is_valid(self):
        form = AddProductForm({
            "name": 'Test Product',
            "category": 'clothing',
            "price": 11,
...
'''.strip()              # no need of decode here anymore
